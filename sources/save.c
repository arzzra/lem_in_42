...
int		create_links_in_rooms(t_graph *gh, char *room1, char *room2)
{
	...
	if ((room1 = search_node_by_name(gh, room1)) && (room2 = search_node_by_name(gh, room2)))
	{
		if (room1 != room2 && malloc_links(room1, room2)
			return (1);
		else
			return (0);
	}
...
void	get_link(t_graph *gh, char *line)
{
	char	*defis;
	char	*room1;
	char	*room2;
